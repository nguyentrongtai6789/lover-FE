...
export const listBaiVietNuoiDayCon: IBaiViet[] = [
  {
    id: 1,
    tieuDe: "Chia sẻ cẩm nang chăm sóc trẻ sơ sinh đúng cách, đơn giản",
    anhTieuDe:
      "https://blogmevabe.vn/wp-content/uploads/2021/11/z2956985639267_c151ffaf7a4ba60e423e9dcd56d1baa3.jpg",
    noiDung:
      "Thành phần chính của sữa là protein và canxi, lipit, đường, vitamin và các loại khoáng chất – nguồn dinh dưỡng không thể thiếu đối với sự phát triển của em bé trong bụng mẹ cũng như đảm bảo sức khỏe cho bà bầu trong suốt quá trình mang thai." +
      "Trong quá trình mang thai, cơ thể người mẹ mất một lượng lớn canxi để hỗ trợ sự phát triển của thai nhi. Do vậy, sữa là nguồn thực phẩm cần thiết giúp mẹ bổ sung canxi một cách nhanh chóng, giảm thiểu tình trạng đau nhức xương khớp do thiếu canxi trong quá trình mang thai. Người mẹ có thể uống từ 3 – 4 ly sữa bầu mỗi ngày, ngoài ra cũng có thể bổ sung canxi từ các loại thực phẩm khác như bông cải xanh, đậu xanh, đậu đỏ và các loại thực phẩm làm từ sữa khác.",
    tacGia: {
      id: 1,
      name: "Nguyễn Thị A",
      avatar:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXKFNk7ckqS2W-hLST_DpXhDrh09PtIb4TsudrrVln4vWYclNPT38OK4SOjb9U5N9sWvM&usqp=CAU",
    },
    createdAt: "12/6/2024",
  },
  {
...
export const listBaiVietKienThucMeBau: IBaiViet[] = [
  {
    id: 1,
    tieuDe: "Chia sẻ kiến thức mẹ bầu",
    anhTieuDe:
      "https://blogmevabe.vn/wp-content/uploads/2021/11/z2956985639267_c151ffaf7a4ba60e423e9dcd56d1baa3.jpg",
    noiDung:
      "Thành phần chính của sữa là protein và canxi, lipit, đường, vitamin và các loại khoáng chất – nguồn dinh dưỡng không thể thiếu đối với sự phát triển của em bé trong bụng mẹ cũng như đảm bảo sức khỏe cho bà bầu trong suốt quá trình mang thai." +
